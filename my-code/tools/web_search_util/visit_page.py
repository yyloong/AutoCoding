...
class Visit_page:
    ...
    api_key = None
    @classmethod
    async def call_tool(cls,params: Union[str, dict], **kwargs) -> str:
        try:
            url = params["url"]
            goal = params["goal"]
        except:
        ...
        if isinstance(url, str):
            response = cls.readpage_jina(url, goal)
        else:
            response = []
            ...
            for u in url: 
                if time.time() - start_time > 900:
                    ...
                    try:
                        cur_response = cls.readpage_jina(u, goal)
    ...
    @classmethod
    def call_server(cls, msgs, max_retries=2):
        client = OpenAI(
            api_key=cls.api_key,
            base_url=cls.url,
        )
    ...
    @classmethod
    def jina_readpage(cls, url: str) -> str:
        """
    ...
    @classmethod
    def html_readpage_jina(cls, url: str) -> str:
        max_attempts = 8
        for attempt in range(max_attempts):
            content = cls.jina_readpage(url)
            service = "jina"     
            print(service)
    ...
    @classmethod
    def readpage_jina(cls, url: str, goal: str) -> str:
        """
        ...
        summary_page_func = cls.call_server
        max_retries = int(os.getenv('VISIT_SERVER_MAX_RETRIES', 1))

        content = cls.html_readpage_jina(url)
